...
- Background pipeline runs (e.g., chain extract → generate end-to-end)
- Specialized subagent for complex, scoped tasks
- Delegating work that needs different tool restrictions or model

## Reference

See Codex plugin's `agents/codex-rescue.md` for a working example.
