...
description: >
  ...
  "query knowledge base", /jx-kb:query, or any question directed at the wiki.
...
If wiki is empty (page_count: 0): "Wiki is empty. Ingest some sources first with `/jx-kb:ingest`."
