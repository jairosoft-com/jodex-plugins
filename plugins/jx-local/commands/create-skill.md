...
allowed-tools: Bash(python3 "${CLAUDE_PLUGIN_ROOT}/scripts/local-skill-creator.py":*), Bash(python3 -m json.tool:*), Bash(git rev-parse --show-toplevel:*), Bash(pwd), Bash(ls:*), Read
---
