...
- [[Static Clarifying Questions in PRD Skill]] — Phase 3 questions are identical regardless of domain; no customization or conditional follow-ups (#jx-pm, #prd, #hardcoded) [raw]
- [[Hardcoded Investment Scale Thresholds]] — Unified mode $50K/$250K thresholds are org-specific; no "Other" escape hatch (#jx-pm, #prd, #hardcoded) [raw]
- [[Quality Gates Assume JS-TS Toolchain]] — Auto-appended quality gates hardcode lint/typecheck; need polyglot support via config (#jx-pm, #prd, #quality-gates) [raw]
