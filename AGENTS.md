...
- `README.md` describes the six-plugin marketplace: `jx-qa`, `jx-kb`, `jx-pm`, `jx-dev`, `jx-core`, and `jx-plugin`.
...
- `jx-plugin` handles skill scaffolding inside existing plugins and new plugin skeleton scaffolding: convention enforcement, trigger uniqueness, boilerplate generation, and marketplace registration.
...
- For helper-script changes, run `python3 -m py_compile plugins/jx-kb/scripts/wiki-tools.py plugins/jx-qa/scripts/xlsx-writer.py plugins/jx-plugin/scripts/skill-creator.py plugins/jx-plugin/scripts/plugin-creator.py`.
